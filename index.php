...
<head>
    ...
    <style>
        html, body {
            max-width: 100%;
            overflow-x: hidden; /* STABILIZER: Stops any viewport shaking or horizontal shifting */
        }
        body {
        ...
        /* RESPONSIVE NAVBAR & NAV LINK STYLES */
        .navbar {
            background: #333;
            color: white;
            padding: 1rem;
        ...
        .navbar ul.nav-links li a:hover {
            background: rgba(230, 126, 34, 0.2); /* Tint matching the orange theme */
            color: #e67e22;
        }
        ...
        /* OPTIMIZED WEBSITE BACKGROUND SETUP */
        .body{
            background-image:url('images/back2.jpg');
...
/* STABILIZED Animation Keyframes using % height scaling */
@keyframes bounce {
...
/* RESPONSIVE HEADER HERO ELEMENTS */
.hero {
    padding: 20px 15px;
    display: flex;
    flex-direction: column;
...
@media (min-width: 992px) {
    ...
    .hero p { grid-column: 1; grid-row: 2; }
    .hero a { grid-column: 2; grid-row: 1 / span 2; margin-left: 20px; }
}
...
<body class="body">
  ...
  <nav class="navbar">
    ...
    <!-- Swap Gallery -->
     <div class="container">
        <h2 style="color:white; padding-left: 15px;">Available for Swap<i class="fa-notdog-duo fa-solid fa-arrow-right" ></i></h2>   
